    ...
    <>
      ...
      >
        <div className="container-narrow flex items-center justify-between py-4 px-4 md:px-8">
          <a href="#" className="logo text-lg font-bold text-cyan-400">
            PH
          </a>
          ...
          <a
            ...
            className="text-sm px-4 py-2 rounded-lg bg-slate-900/50 border border-slate-800 text-slate-50 hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 font-medium"
