...
export const PROJECTS: Project[] = [
  {
    ...
    description: "Financial assistant prototype automating expense tracking, reducing manual entry time by 60%.",
  ...
  },
  {
    ...
    description: "AI-driven platform integrating Spotify API for emotion-based playlists with real-time sentiment analysis.",
  ...
  },
  {
    ...
    description: "Scalable meal planner dynamically adjusting ingredients and streamlining grocery lists.",
    tech: ["Python", "Flask"],
    badge: "Personal",
  },
];
